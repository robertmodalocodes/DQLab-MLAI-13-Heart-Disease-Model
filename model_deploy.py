...
add_selectitem = st.sidebar.selectbox(
    "Want to open about?", ("Heart Disease!", "Iris species!"))
...
def iris():
    ...
    if st.sidebar.button('Predict!'):
        ...
        result = ['Iris-setosa' if prediction ==
                  0 else ('Iris-versicolor' if prediction == 1 else 'Iris-virginica')]
